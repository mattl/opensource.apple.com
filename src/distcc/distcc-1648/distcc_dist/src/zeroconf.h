...
int dcc_zeroconf_add_hosts(struct dcc_hostdef **re_list, int *ret_nhosts,
                           int slots, struct dcc_hostdef **ret_prev);
...
char* dcc_make_dnssd_subtype(char *stype, size_t nbytes, const char *v,
                             const char *m);
