...
SYSTEM_DEVELOPER_APPS_DIR = $(SYSTEM_DEVELOPER_DIR)/Applications
SYSTEM_DEVELOPER_JAVA_TOOLS_DIR = $(SYSTEM_DEVELOPER_DIR)/Applications/Java Tools
SYSTEM_DEVELOPER_PERFORMANCE_TOOLS_DIR = $(SYSTEM_DEVELOPER_DIR)/Applications/Performance Tools
SYSTEM_DEVELOPER_GRAPHICS_TOOLS_DIR = $(SYSTEM_DEVELOPER_DIR)/Applications/Graphics Tools
SYSTEM_DEVELOPER_UTILITIES_DIR = $(SYSTEM_DEVELOPER_DIR)/Applications/Utilities
SYSTEM_DEVELOPER_DEMOS_DIR = $(SYSTEM_DEVELOPER_DIR)/Applications/Utilities/Built Examples
SYSTEM_DEVELOPER_DOC_DIR = $(SYSTEM_DEVELOPER_DIR)/ADC Reference Library
SYSTEM_DEVELOPER_TOOLS_DOC_DIR = $(SYSTEM_DEVELOPER_DIR)/ADC Reference Library/documentation/DeveloperTools
SYSTEM_DEVELOPER_RELEASENOTES_DIR = $(SYSTEM_DEVELOPER_DIR)/ADC Reference Library/releasenotes
SYSTEM_DEVELOPER_TOOLS_RELEASENOTES_DIR = $(SYSTEM_DEVELOPER_DIR)/ADC Reference Library/releasenotes/DeveloperTools
